...
public:
  ...
  explicit PostgreSQLLexer(antlr4::CharStream *input);

  ~PostgreSQLLexer() override;
...
private:
  ...
  void OperatorAction(antlr4::RuleContext *context, size_t actionIndex);
  void BeginDollarStringConstantAction(antlr4::RuleContext *context, size_t actionIndex);
  void NumericFailAction(antlr4::RuleContext *context, size_t actionIndex);
  void UnterminatedBlockCommentAction(antlr4::RuleContext *context, size_t actionIndex);
  void EndDollarStringConstantAction(antlr4::RuleContext *context, size_t actionIndex);

  // Individual semantic predicate functions triggered by sempred() above.
  bool OperatorSempred(antlr4::RuleContext *_localctx, size_t predicateIndex);
  bool OperatorEndingWithPlusMinusSempred(antlr4::RuleContext *_localctx, size_t predicateIndex);
  bool IdentifierStartCharSempred(antlr4::RuleContext *_localctx, size_t predicateIndex);
  bool EndDollarStringConstantSempred(antlr4::RuleContext *_localctx, size_t predicateIndex);
  bool MetaSemiSempred(antlr4::RuleContext *_localctx, size_t predicateIndex);
