...
#include "MySQLParserBase.h" // <--- ★★★ 이 줄을 직접 추가하세요! ★★★
...
public:
  enum {
    ...
    MANUAL_SYMBOL = 814, BERNOULLI_SYMBOL = 815, TABLESAMPLE_SYMBOL = 816, 
    WHITESPACE = 817, INVALID_INPUT = 818, UNDERSCORE_CHARSET = 819, DOLLAR_QUOTED_STRING_TEXT = 820, 
  ...
  enum {
    RuleQueries = 0, RuleQuery = 1, RuleSimpleStatement = 2, RuleAlterStatement = 3, 
    RuleAlterDatabase = 4, RuleAlterDatabaseOption = 5, RuleAlterEvent = 6, 
    RuleAlterLogfileGroup = 7, RuleAlterLogfileGroupOptions = 8, RuleAlterLogfileGroupOption = 9, 
    RuleAlterServer = 10, RuleAlterTable = 11, RuleAlterTableActions = 12, 
    RuleAlterCommandList = 13, RuleAlterCommandsModifierList = 14, RuleStandaloneAlterCommands = 15, 
    ...
    RuleAlterTablespace = 29, RuleAlterUndoTablespace = 30, RuleUndoTableSpaceOptions = 31, 
    RuleUndoTableSpaceOption = 32, RuleAlterTablespaceOptions = 33, RuleAlterTablespaceOption = 34, 
    RuleChangeTablespaceOption = 35, RuleAlterView = 36, RuleViewTail = 37, 
    RuleViewQueryBlock = 38, RuleViewCheckOption = 39, RuleAlterInstanceStatement = 40, 
    RuleCreateStatement = 41, RuleCreateDatabase = 42, RuleCreateDatabaseOption = 43, 
    RuleCreateTable = 44, RuleTableElementList = 45, RuleTableElement = 46, 
    RuleDuplicateAsQe = 47, RuleAsCreateQueryExpression = 48, RuleQueryExpressionOrParens = 49, 
    RuleQueryExpressionWithOptLockingClauses = 50, RuleCreateRoutine = 51, 
    RuleCreateProcedure = 52, RuleRoutineString = 53, RuleStoredRoutineBody = 54, 
    RuleCreateFunction = 55, RuleCreateUdf = 56, RuleRoutineCreateOption = 57, 
    RuleRoutineAlterOptions = 58, RuleRoutineOption = 59, RuleCreateIndex = 60, 
    RuleIndexNameAndType = 61, RuleCreateIndexTarget = 62, RuleCreateLogfileGroup = 63, 
    RuleLogfileGroupOptions = 64, RuleLogfileGroupOption = 65, RuleCreateServer = 66, 
    RuleServerOptions = 67, RuleServerOption = 68, RuleCreateTablespace = 69, 
    RuleCreateUndoTablespace = 70, RuleTsDataFileName = 71, RuleTsDataFile = 72, 
    RuleTablespaceOptions = 73, RuleTablespaceOption = 74, RuleTsOptionInitialSize = 75, 
    RuleTsOptionUndoRedoBufferSize = 76, RuleTsOptionAutoextendSize = 77, 
    RuleTsOptionMaxSize = 78, RuleTsOptionExtentSize = 79, RuleTsOptionNodegroup = 80, 
    RuleTsOptionEngine = 81, RuleTsOptionWait = 82, RuleTsOptionComment = 83, 
    RuleTsOptionFileblockSize = 84, RuleTsOptionEncryption = 85, RuleTsOptionEngineAttribute = 86, 
    RuleCreateView = 87, RuleViewReplaceOrAlgorithm = 88, RuleViewAlgorithm = 89, 
    RuleViewSuid = 90, RuleCreateTrigger = 91, RuleTriggerFollowsPrecedesClause = 92, 
    RuleCreateEvent = 93, RuleCreateRole = 94, RuleCreateSpatialReference = 95, 
    RuleSrsAttribute = 96, RuleDropStatement = 97, RuleDropDatabase = 98, 
    RuleDropEvent = 99, RuleDropFunction = 100, RuleDropProcedure = 101, 
    RuleDropIndex = 102, RuleDropLogfileGroup = 103, RuleDropLogfileGroupOption = 104, 
    RuleDropServer = 105, RuleDropTable = 106, RuleDropTableSpace = 107, 
    RuleDropTrigger = 108, RuleDropView = 109, RuleDropRole = 110, RuleDropSpatialReference = 111, 
    RuleDropUndoTablespace = 112, RuleRenameTableStatement = 113, RuleRenamePair = 114, 
    RuleTruncateTableStatement = 115, RuleImportStatement = 116, RuleCallStatement = 117, 
    RuleDeleteStatement = 118, RulePartitionDelete = 119, RuleDeleteStatementOption = 120, 
    RuleDoStatement = 121, RuleHandlerStatement = 122, RuleHandlerReadOrScan = 123, 
    RuleInsertStatement = 124, RuleInsertLockOption = 125, RuleInsertFromConstructor = 126, 
    RuleFields = 127, RuleInsertValues = 128, RuleInsertQueryExpression = 129, 
    RuleValueList = 130, RuleValues = 131, RuleValuesReference = 132, RuleInsertUpdateList = 133, 
    RuleLoadStatement = 134, RuleDataOrXml = 135, RuleLoadDataLock = 136, 
    RuleLoadFrom = 137, RuleLoadSourceType = 138, RuleSourceCount = 139, 
    RuleSourceOrder = 140, RuleXmlRowsIdentifiedBy = 141, RuleLoadDataFileTail = 142, 
    RuleLoadDataFileTargetList = 143, RuleFieldOrVariableList = 144, RuleLoadAlgorithm = 145, 
    RuleLoadParallel = 146, RuleLoadMemory = 147, RuleReplaceStatement = 148, 
    RuleSelectStatement = 149, RuleSelectStatementWithInto = 150, RuleQueryExpression = 151, 
    RuleQueryExpressionBody = 152, RuleQueryExpressionParens = 153, RuleQueryPrimary = 154, 
    RuleQuerySpecification = 155, RuleSubquery = 156, RuleQuerySpecOption = 157, 
    RuleLimitClause = 158, RuleSimpleLimitClause = 159, RuleLimitOptions = 160, 
    RuleLimitOption = 161, RuleIntoClause = 162, RuleProcedureAnalyseClause = 163, 
    RuleHavingClause = 164, RuleQualifyClause = 165, RuleWindowClause = 166, 
    RuleWindowDefinition = 167, RuleWindowSpec = 168, RuleWindowSpecDetails = 169, 
    RuleWindowFrameClause = 170, RuleWindowFrameUnits = 171, RuleWindowFrameExtent = 172, 
    RuleWindowFrameStart = 173, RuleWindowFrameBetween = 174, RuleWindowFrameBound = 175, 
    RuleWindowFrameExclusion = 176, RuleWithClause = 177, RuleCommonTableExpression = 178, 
    RuleGroupByClause = 179, RuleOlapOption = 180, RuleOrderClause = 181, 
    RuleDirection = 182, RuleFromClause = 183, RuleTableReferenceList = 184, 
    RuleTableValueConstructor = 185, RuleExplicitTable = 186, RuleRowValueExplicit = 187, 
    RuleSelectOption = 188, RuleLockingClauseList = 189, RuleLockingClause = 190, 
    RuleLockStrengh = 191, RuleLockedRowAction = 192, RuleSelectItemList = 193, 
    RuleSelectItem = 194, RuleSelectAlias = 195, RuleWhereClause = 196, 
    RuleTableReference = 197, RuleEscapedTableReference = 198, RuleJoinedTable = 199, 
    RuleNaturalJoinType = 200, RuleInnerJoinType = 201, RuleOuterJoinType = 202, 
    RuleTableFactor = 203, RuleSingleTable = 204, RuleSingleTableParens = 205, 
    RuleDerivedTable = 206, RuleTableReferenceListParens = 207, RuleTableFunction = 208, 
    RuleColumnsClause = 209, RuleJtColumn = 210, RuleOnEmptyOrError = 211, 
    RuleOnEmptyOrErrorJsonTable = 212, RuleOnEmpty = 213, RuleOnError = 214, 
    RuleJsonOnResponse = 215, RuleUnionOption = 216, RuleTableAlias = 217, 
    RuleIndexHintList = 218, RuleIndexHint = 219, RuleIndexHintType = 220, 
    RuleKeyOrIndex = 221, RuleConstraintKeyType = 222, RuleIndexHintClause = 223, 
    RuleIndexList = 224, RuleIndexListElement = 225, RuleUpdateStatement = 226, 
    RuleTransactionOrLockingStatement = 227, RuleTransactionStatement = 228, 
    RuleBeginWork = 229, RuleStartTransactionOptionList = 230, RuleSavepointStatement = 231, 
    RuleLockStatement = 232, RuleLockItem = 233, RuleLockOption = 234, RuleXaStatement = 235, 
    RuleXaConvert = 236, RuleXid = 237, RuleReplicationStatement = 238, 
    RulePurgeOptions = 239, RuleResetOption = 240, RuleMasterOrBinaryLogsAndGtids = 241, 
    RuleSourceResetOptions = 242, RuleReplicationLoad = 243, RuleChangeReplicationSource = 244, 
    RuleChangeSource = 245, RuleSourceDefinitions = 246, RuleSourceDefinition = 247, 
    RuleChangeReplicationSourceAutoPosition = 248, RuleChangeReplicationSourceHost = 249, 
    RuleChangeReplicationSourceBind = 250, RuleChangeReplicationSourceUser = 251, 
    RuleChangeReplicationSourcePassword = 252, RuleChangeReplicationSourcePort = 253, 
    RuleChangeReplicationSourceConnectRetry = 254, RuleChangeReplicationSourceRetryCount = 255, 
    RuleChangeReplicationSourceDelay = 256, RuleChangeReplicationSourceSSL = 257, 
    RuleChangeReplicationSourceSSLCA = 258, RuleChangeReplicationSourceSSLCApath = 259, 
    RuleChangeReplicationSourceSSLCipher = 260, RuleChangeReplicationSourceSSLCLR = 261, 
    RuleChangeReplicationSourceSSLCLRpath = 262, RuleChangeReplicationSourceSSLKey = 263, 
    RuleChangeReplicationSourceSSLVerifyServerCert = 264, RuleChangeReplicationSourceTLSVersion = 265, 
    RuleChangeReplicationSourceTLSCiphersuites = 266, RuleChangeReplicationSourceSSLCert = 267, 
    RuleChangeReplicationSourcePublicKey = 268, RuleChangeReplicationSourceGetSourcePublicKey = 269, 
    RuleChangeReplicationSourceHeartbeatPeriod = 270, RuleChangeReplicationSourceCompressionAlgorithm = 271, 
    RuleChangeReplicationSourceZstdCompressionLevel = 272, RulePrivilegeCheckDef = 273, 
    RuleTablePrimaryKeyCheckDef = 274, RuleAssignGtidsToAnonymousTransactionsDefinition = 275, 
    RuleSourceTlsCiphersuitesDef = 276, RuleSourceFileDef = 277, RuleSourceLogFile = 278, 
    RuleSourceLogPos = 279, RuleServerIdList = 280, RuleChangeReplication = 281, 
    RuleFilterDefinition = 282, RuleFilterDbList = 283, RuleFilterTableList = 284, 
    RuleFilterStringList = 285, RuleFilterWildDbTableString = 286, RuleFilterDbPairList = 287, 
    RuleStartReplicaStatement = 288, RuleStopReplicaStatement = 289, RuleReplicaUntil = 290, 
    RuleUserOption = 291, RulePasswordOption = 292, RuleDefaultAuthOption = 293, 
    RulePluginDirOption = 294, RuleReplicaThreadOptions = 295, RuleReplicaThreadOption = 296, 
    RuleGroupReplication = 297, RuleGroupReplicationStartOptions = 298, 
    RuleGroupReplicationStartOption = 299, RuleGroupReplicationUser = 300, 
    RuleGroupReplicationPassword = 301, RuleGroupReplicationPluginAuth = 302, 
    RuleReplica = 303, RulePreparedStatement = 304, RuleExecuteStatement = 305, 
    RuleExecuteVarList = 306, RuleCloneStatement = 307, RuleDataDirSSL = 308, 
    RuleSsl = 309, RuleAccountManagementStatement = 310, RuleAlterUserStatement = 311, 
    RuleAlterUserList = 312, RuleAlterUser = 313, RuleOldAlterUser = 314, 
    RuleUserFunction = 315, RuleCreateUserStatement = 316, RuleCreateUserTail = 317, 
    RuleUserAttributes = 318, RuleDefaultRoleClause = 319, RuleRequireClause = 320, 
    RuleConnectOptions = 321, RuleAccountLockPasswordExpireOptions = 322, 
    RuleUserAttribute = 323, RuleDropUserStatement = 324, RuleGrantStatement = 325, 
    RuleGrantTargetList = 326, RuleGrantOptions = 327, RuleExceptRoleList = 328, 
    RuleWithRoles = 329, RuleGrantAs = 330, RuleVersionedRequireClause = 331, 
    RuleRenameUserStatement = 332, RuleRevokeStatement = 333, RuleAclType = 334, 
    RuleRoleOrPrivilegesList = 335, RuleRoleOrPrivilege = 336, RuleGrantIdentifier = 337, 
    RuleRequireList = 338, RuleRequireListElement = 339, RuleGrantOption = 340, 
    RuleSetRoleStatement = 341, RuleRoleList = 342, RuleRole = 343, RuleTableAdministrationStatement = 344, 
    RuleHistogramAutoUpdate = 345, RuleHistogramUpdateParam = 346, RuleHistogramNumBuckets = 347, 
    RuleHistogram = 348, RuleCheckOption = 349, RuleRepairType = 350, RuleUninstallStatement = 351, 
    RuleInstallStatement = 352, RuleInstallOptionType = 353, RuleInstallSetRvalue = 354, 
    RuleInstallSetValue = 355, RuleInstallSetValueList = 356, RuleSetStatement = 357, 
    RuleStartOptionValueList = 358, RuleTransactionCharacteristics = 359, 
    RuleTransactionAccessMode = 360, RuleIsolationLevel = 361, RuleOptionValueListContinued = 362, 
    RuleOptionValueNoOptionType = 363, RuleOptionValue = 364, RuleSetSystemVariable = 365, 
    RuleStartOptionValueListFollowingOptionType = 366, RuleOptionValueFollowingOptionType = 367, 
    RuleSetExprOrDefault = 368, RuleShowDatabasesStatement = 369, RuleShowTablesStatement = 370, 
    RuleShowTriggersStatement = 371, RuleShowEventsStatement = 372, RuleShowTableStatusStatement = 373, 
    RuleShowOpenTablesStatement = 374, RuleShowParseTreeStatement = 375, 
    RuleShowPluginsStatement = 376, RuleShowEngineLogsStatement = 377, RuleShowEngineMutexStatement = 378, 
    RuleShowEngineStatusStatement = 379, RuleShowColumnsStatement = 380, 
    RuleShowBinaryLogsStatement = 381, RuleShowBinaryLogStatusStatement = 382, 
    RuleShowReplicasStatement = 383, RuleShowBinlogEventsStatement = 384, 
    RuleShowRelaylogEventsStatement = 385, RuleShowKeysStatement = 386, 
    RuleShowEnginesStatement = 387, RuleShowCountWarningsStatement = 388, 
    RuleShowCountErrorsStatement = 389, RuleShowWarningsStatement = 390, 
    RuleShowErrorsStatement = 391, RuleShowProfilesStatement = 392, RuleShowProfileStatement = 393, 
    RuleShowStatusStatement = 394, RuleShowProcessListStatement = 395, RuleShowVariablesStatement = 396, 
    RuleShowCharacterSetStatement = 397, RuleShowCollationStatement = 398, 
    RuleShowPrivilegesStatement = 399, RuleShowGrantsStatement = 400, RuleShowCreateDatabaseStatement = 401, 
    RuleShowCreateTableStatement = 402, RuleShowCreateViewStatement = 403, 
    RuleShowMasterStatusStatement = 404, RuleShowReplicaStatusStatement = 405, 
    RuleShowCreateProcedureStatement = 406, RuleShowCreateFunctionStatement = 407, 
    RuleShowCreateTriggerStatement = 408, RuleShowCreateProcedureStatusStatement = 409, 
    RuleShowCreateFunctionStatusStatement = 410, RuleShowCreateProcedureCodeStatement = 411, 
    RuleShowCreateFunctionCodeStatement = 412, RuleShowCreateEventStatement = 413, 
    RuleShowCreateUserStatement = 414, RuleShowCommandType = 415, RuleEngineOrAll = 416, 
    RuleFromOrIn = 417, RuleInDb = 418, RuleProfileDefinitions = 419, RuleProfileDefinition = 420, 
    RuleOtherAdministrativeStatement = 421, RuleKeyCacheListOrParts = 422, 
    RuleKeyCacheList = 423, RuleAssignToKeycache = 424, RuleAssignToKeycachePartition = 425, 
    RuleCacheKeyList = 426, RuleKeyUsageElement = 427, RuleKeyUsageList = 428, 
    RuleFlushOption = 429, RuleLogType = 430, RuleFlushTables = 431, RuleFlushTablesOptions = 432, 
    RulePreloadTail = 433, RulePreloadList = 434, RulePreloadKeys = 435, 
    RuleAdminPartition = 436, RuleResourceGroupManagement = 437, RuleCreateResourceGroup = 438, 
    RuleResourceGroupVcpuList = 439, RuleVcpuNumOrRange = 440, RuleResourceGroupPriority = 441, 
    RuleResourceGroupEnableDisable = 442, RuleAlterResourceGroup = 443, 
    RuleSetResourceGroup = 444, RuleThreadIdList = 445, RuleDropResourceGroup = 446, 
    RuleUtilityStatement = 447, RuleDescribeStatement = 448, RuleExplainStatement = 449, 
    RuleExplainOptions = 450, RuleExplainableStatement = 451, RuleExplainInto = 452, 
    RuleHelpCommand = 453, RuleUseCommand = 454, RuleRestartServer = 455, 
    RuleExpr = 456, RuleBoolPri = 457, RuleCompOp = 458, RulePredicate = 459, 
    RulePredicateOperations = 460, RuleBitExpr = 461, RuleSimpleExpr = 462, 
    RuleArrayCast = 463, RuleJsonOperator = 464, RuleSumExpr = 465, RuleGroupingOperation = 466, 
    RuleWindowFunctionCall = 467, RuleSamplingMethod = 468, RuleSamplingPercentage = 469, 
    RuleTablesampleClause = 470, RuleWindowingClause = 471, RuleLeadLagInfo = 472, 
    RuleStableInteger = 473, RuleParamOrVar = 474, RuleNullTreatment = 475, 
    RuleJsonFunction = 476, RuleInSumExpr = 477, RuleIdentListArg = 478, 
    RuleIdentList = 479, RuleFulltextOptions = 480, RuleRuntimeFunctionCall = 481, 
    RuleReturningType = 482, RuleGeometryFunction = 483, RuleTimeFunctionParameters = 484, 
    RuleFractionalPrecision = 485, RuleWeightStringLevels = 486, RuleWeightStringLevelListItem = 487, 
    RuleDateTimeTtype = 488, RuleTrimFunction = 489, RuleSubstringFunction = 490, 
    RuleFunctionCall = 491, RuleUdfExprList = 492, RuleUdfExpr = 493, RuleUserVariable = 494, 
    RuleInExpressionUserVariableAssignment = 495, RuleRvalueSystemOrUserVariable = 496, 
    RuleLvalueVariable = 497, RuleRvalueSystemVariable = 498, RuleWhenExpression = 499, 
    RuleThenExpression = 500, RuleElseExpression = 501, RuleCastType = 502, 
    RuleExprList = 503, RuleCharset = 504, RuleNotRule = 505, RuleNot2Rule = 506, 
    RuleInterval = 507, RuleIntervalTimeStamp = 508, RuleExprListWithParentheses = 509, 
    RuleExprWithParentheses = 510, RuleSimpleExprWithParentheses = 511, 
    RuleOrderList = 512, RuleOrderExpression = 513, RuleGroupList = 514, 
    RuleGroupingExpression = 515, RuleChannel = 516, RuleCompoundStatement = 517, 
    RuleReturnStatement = 518, RuleIfStatement = 519, RuleIfBody = 520, 
    RuleThenStatement = 521, RuleCompoundStatementList = 522, RuleCaseStatement = 523, 
    RuleElseStatement = 524, RuleLabeledBlock = 525, RuleUnlabeledBlock = 526, 
    RuleLabel = 527, RuleBeginEndBlock = 528, RuleLabeledControl = 529, 
    RuleUnlabeledControl = 530, RuleLoopBlock = 531, RuleWhileDoBlock = 532, 
    RuleRepeatUntilBlock = 533, RuleSpDeclarations = 534, RuleSpDeclaration = 535, 
    RuleVariableDeclaration = 536, RuleConditionDeclaration = 537, RuleSpCondition = 538, 
    RuleSqlstate = 539, RuleHandlerDeclaration = 540, RuleHandlerCondition = 541, 
    RuleCursorDeclaration = 542, RuleIterateStatement = 543, RuleLeaveStatement = 544, 
    RuleGetDiagnosticsStatement = 545, RuleSignalAllowedExpr = 546, RuleStatementInformationItem = 547, 
    RuleConditionInformationItem = 548, RuleSignalInformationItemName = 549, 
    RuleSignalStatement = 550, RuleResignalStatement = 551, RuleSignalInformationItem = 552, 
    RuleCursorOpen = 553, RuleCursorClose = 554, RuleCursorFetch = 555, 
    RuleSchedule = 556, RuleColumnDefinition = 557, RuleCheckOrReferences = 558, 
    RuleCheckConstraint = 559, RuleConstraintEnforcement = 560, RuleTableConstraintDef = 561, 
    RuleConstraintName = 562, RuleFieldDefinition = 563, RuleColumnAttribute = 564, 
    RuleColumnFormat = 565, RuleStorageMedia = 566, RuleNow = 567, RuleNowOrSignedLiteral = 568, 
    RuleGcolAttribute = 569, RuleReferences = 570, RuleDeleteOption = 571, 
    RuleKeyList = 572, RuleKeyPart = 573, RuleKeyListWithExpression = 574, 
    RuleKeyPartOrExpression = 575, RuleIndexType = 576, RuleIndexOption = 577, 
    RuleCommonIndexOption = 578, RuleVisibility = 579, RuleIndexTypeClause = 580, 
    RuleFulltextIndexOption = 581, RuleSpatialIndexOption = 582, RuleDataTypeDefinition = 583, 
    RuleDataType = 584, RuleNchar = 585, RuleRealType = 586, RuleFieldLength = 587, 
    RuleFieldOptions = 588, RuleCharsetWithOptBinary = 589, RuleAscii = 590, 
    RuleUnicode = 591, RuleWsNumCodepoints = 592, RuleTypeDatetimePrecision = 593, 
    RuleFunctionDatetimePrecision = 594, RuleCharsetName = 595, RuleCollationName = 596, 
    RuleCreateTableOptions = 597, RuleCreateTableOptionsEtc = 598, RuleCreatePartitioningEtc = 599, 
    RuleCreateTableOptionsSpaceSeparated = 600, RuleCreateTableOption = 601, 
    RuleTernaryOption = 602, RuleDefaultCollation = 603, RuleDefaultEncryption = 604, 
    RuleDefaultCharset = 605, RulePartitionClause = 606, RulePartitionTypeDef = 607, 
    RuleSubPartitions = 608, RulePartitionKeyAlgorithm = 609, RulePartitionDefinitions = 610, 
    RulePartitionDefinition = 611, RulePartitionValuesIn = 612, RulePartitionOption = 613, 
    RuleSubpartitionDefinition = 614, RulePartitionValueItemListParen = 615, 
    RulePartitionValueItem = 616, RuleDefinerClause = 617, RuleIfExists = 618, 
    RuleIfExistsIdentifier = 619, RulePersistedVariableIdentifier = 620, 
    RuleIfNotExists = 621, RuleIgnoreUnknownUser = 622, RuleProcedureParameter = 623, 
    RuleFunctionParameter = 624, RuleCollate = 625, RuleTypeWithOptCollate = 626, 
    RuleSchemaIdentifierPair = 627, RuleViewRefList = 628, RuleUpdateList = 629, 
    RuleUpdateElement = 630, RuleCharsetClause = 631, RuleFieldsClause = 632, 
    RuleFieldTerm = 633, RuleLinesClause = 634, RuleLineTerm = 635, RuleUserList = 636, 
    RuleCreateUserList = 637, RuleCreateUser = 638, RuleCreateUserWithMfa = 639, 
    RuleIdentification = 640, RuleIdentifiedByPassword = 641, RuleIdentifiedByRandomPassword = 642, 
    RuleIdentifiedWithPlugin = 643, RuleIdentifiedWithPluginAsAuth = 644, 
    RuleIdentifiedWithPluginByPassword = 645, RuleIdentifiedWithPluginByRandomPassword = 646, 
    RuleInitialAuth = 647, RuleRetainCurrentPassword = 648, RuleDiscardOldPassword = 649, 
    RuleUserRegistration = 650, RuleFactor = 651, RuleReplacePassword = 652, 
    RuleUserIdentifierOrText = 653, RuleUser = 654, RuleLikeClause = 655, 
    RuleLikeOrWhere = 656, RuleOnlineOption = 657, RuleNoWriteToBinLog = 658, 
    RuleUsePartition = 659, RuleFieldIdentifier = 660, RuleColumnName = 661, 
    RuleColumnInternalRef = 662, RuleColumnInternalRefList = 663, RuleColumnRef = 664, 
    RuleInsertIdentifier = 665, RuleIndexName = 666, RuleIndexRef = 667, 
    RuleTableWild = 668, RuleSchemaName = 669, RuleSchemaRef = 670, RuleProcedureName = 671, 
    RuleProcedureRef = 672, RuleFunctionName = 673, RuleFunctionRef = 674, 
    RuleTriggerName = 675, RuleTriggerRef = 676, RuleViewName = 677, RuleViewRef = 678, 
    RuleTablespaceName = 679, RuleTablespaceRef = 680, RuleLogfileGroupName = 681, 
    RuleLogfileGroupRef = 682, RuleEventName = 683, RuleEventRef = 684, 
    RuleUdfName = 685, RuleServerName = 686, RuleServerRef = 687, RuleEngineRef = 688, 
    RuleTableName = 689, RuleFilterTableRef = 690, RuleTableRefWithWildcard = 691, 
    RuleTableRef = 692, RuleTableRefList = 693, RuleTableAliasRefList = 694, 
    RuleParameterName = 695, RuleLabelIdentifier = 696, RuleLabelRef = 697, 
    RuleRoleIdentifier = 698, RulePluginRef = 699, RuleComponentRef = 700, 
    RuleResourceGroupRef = 701, RuleWindowName = 702, RulePureIdentifier = 703, 
    RuleIdentifier = 704, RuleIdentifierList = 705, RuleIdentifierListWithParentheses = 706, 
    RuleQualifiedIdentifier = 707, RuleSimpleIdentifier = 708, RuleDotIdentifier = 709, 
    RuleUlong_number = 710, RuleReal_ulong_number = 711, RuleUlonglongNumber = 712, 
    RuleReal_ulonglong_number = 713, RuleSignedLiteral = 714, RuleSignedLiteralOrNull = 715, 
    RuleLiteral = 716, RuleLiteralOrNull = 717, RuleNullAsLiteral = 718, 
    RuleStringList = 719, RuleTextStringLiteral = 720, RuleTextString = 721, 
    RuleTextStringHash = 722, RuleTextLiteral = 723, RuleTextStringNoLinebreak = 724, 
    RuleTextStringLiteralList = 725, RuleNumLiteral = 726, RuleBoolLiteral = 727, 
    RuleNullLiteral = 728, RuleInt64Literal = 729, RuleTemporalLiteral = 730, 
    RuleFloatOptions = 731, RuleStandardFloatOptions = 732, RulePrecision = 733, 
    RuleTextOrIdentifier = 734, RuleLValueIdentifier = 735, RuleRoleIdentifierOrText = 736, 
    RuleSizeNumber = 737, RuleParentheses = 738, RuleEqual = 739, RuleOptionType = 740, 
    RuleRvalueSystemVariableType = 741, RuleSetVarIdentType = 742, RuleJsonAttribute = 743, 
    RuleIdentifierKeyword = 744, RuleIdentifierKeywordsAmbiguous1RolesAndLabels = 745, 
    RuleIdentifierKeywordsAmbiguous2Labels = 746, RuleLabelKeyword = 747, 
    RuleIdentifierKeywordsAmbiguous3Roles = 748, RuleIdentifierKeywordsUnambiguous = 749, 
    RuleRoleKeyword = 750, RuleLValueKeyword = 751, RuleIdentifierKeywordsAmbiguous4SystemVariables = 752, 
    RuleRoleOrIdentifierKeyword = 753, RuleRoleOrLabelKeyword = 754
  };
