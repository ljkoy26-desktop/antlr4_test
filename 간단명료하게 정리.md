...
java -jar antlr-4.13.2-complete.jar -Dlanguage=Cpp -no-listener -visitor -o oracle_gen PlSqlLexer.g4
java -jar antlr-4.13.2-complete.jar -Dlanguage=Cpp -no-listener -visitor -o oracle_gen PlSqlParser.g4

		  
java -jar antlr-4.13.2-complete.jar -Dlanguage=Cpp -no-listener -visitor -o sqlserver_gen TSqlLexer.g4
java -jar antlr-4.13.2-complete.jar -Dlanguage=Cpp -no-listener -visitor -o sqlserver_gen TSqlParser.g4
		  		  
		  
java -jar antlr-4.13.2-complete.jar -Dlanguage=Cpp -no-listener -visitor -o mysql_gen MySQLLexer.g4
java -jar antlr-4.13.2-complete.jar -Dlanguage=Cpp -no-listener -visitor -o mysql_gen MySQLParser.g4
		  
		  
java -jar antlr-4.13.2-complete.jar -Dlanguage=Cpp -no-listener -visitor -o postgres_gen PostgreSQLLexer.g4
java -jar antlr-4.13.2-complete.jar -Dlanguage=Cpp -no-listener -visitor -o postgres_gen PostgreSQLParser.g4
